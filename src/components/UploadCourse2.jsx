...
export default function UploadCourse2() {
  ...
  return (
    ...
    <RiUploadLine onClick={handleClickOpen} title={"Upload course"} size={36} style={{padding: 8, background: "#f2f0f5", borderRadius: "50%", cursor: "pointer"}} />
      <Dialog
        open={open}
        onClose={handleClose}
